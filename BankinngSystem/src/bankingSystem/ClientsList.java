...
public class ClientsList extends JFrame implements ActionListener{
	JLabel text;
	JTable t1;
	JButton exit;
	public ClientsList(String string) {
		setLayout(null);
		
		text = new JLabel("List of Clients");
		...
		try {
			...
			ResultSet rs = c.s.executeQuery("select * from SignupTwo ");
