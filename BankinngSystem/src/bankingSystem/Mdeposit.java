...
public class Mdeposit extends JFrame implements ActionListener{
	JLabel text, text1;
	JTable t1;
	...
	public void actionPerformed(ActionEvent e) {
		...
		new Manager(toString()).setVisible(true);
            ...
            try {
    			...
    			ResultSet rs = c.s.executeQuery("SELECT pin as Accountnumber ,type, SUM(amount) FROM bank WHERE pin ='"+accountNumber+"' AND type = 'deposit' AND date >= '"+startDate+"' AND date <= '"+endDate+"'");
